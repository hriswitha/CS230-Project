...
// LAST LEVEL CACHE
#define LLC_SET NUM_CPUS*2048*10
#define LLC_WAY 16
...
class CACHE : public MEMORY {
  public:
    ...
    // hawkeye replacement req fxns
    void hawkeye_initialize_replacement();
    uint32_t hawkeye_find_victim(uint32_t cpu, uint32_t set, const BLOCK *current_set, uint64_t PC, uint64_t paddr, uint32_t type);
